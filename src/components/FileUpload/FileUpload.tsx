  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-4">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-3">Upload Campaign Data</h2>
        <p className="text-gray-600">Upload your email campaign data (CSV or Excel) to automatically generate insights</p>
      </div>
